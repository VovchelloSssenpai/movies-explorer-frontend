...
function Navigation({ isActive, loggedIn }) {
  ...
  function handleNavigation(){
    if (location.pathname === "/signin") {return }
    ...
    else if(location.pathname === "/"){return (!loggedIn ? <nav className={`navigation-landing`}><div className='navigation-landing__wrapper'>
                                              ...
                                              </div></nav> : (<nav className={`navigation ${isActive ? `navigation_active` : ``}`}><div className='navigation__wrapper'>
